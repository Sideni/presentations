DROP DATABASE chal11DB;
CREATE DATABASE chal11DB CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

CREATE USER 'chal11'@'localhost' IDENTIFIED BY 'chal11';

GRANT SELECT ON chal11DB.* TO 'chal11'@'localhost';
GRANT FILE ON *.* TO 'chal11'@'localhost';

CREATE TABLE chal11DB.users (
	username varchar(40) NOT NULL PRIMARY KEY,
	password varchar(40) NOT NULL
);
INSERT INTO chal11DB.users
